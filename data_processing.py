...
def get_control_data(DATA_DIRECTORY):
    ...
    for ens in range(0,10):
        ...
        filename_ssp_f1 = DATA_DIRECTORY + 'b.e21.BWSSP245cmip6.f09_g17.CMIP6-SSP2-4.5-WACCM.' + member_text + '.cam.h0.TREFHT.201501-206412.nc'
        filename_ssp_f2 = DATA_DIRECTORY + 'b.e21.BWSSP245cmip6.f09_g17.CMIP6-SSP2-4.5-WACCM.' + member_text + '.cam.h0.TREFHT.206501-206912.nc'
        if exists(filename_ssp_f2) == False:
            filename_ssp_f2 = DATA_DIRECTORY + 'b.e21.BWSSP245cmip6.f09_g17.CMIP6-SSP2-4.5-WACCM.' + member_text + '.cam.h0.TREFHT.206501-210012.nc'
        das = xr.open_mfdataset((filename_ssp_f1,filename_ssp_f2))
